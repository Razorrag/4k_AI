...
export const UploadIcon: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 16.5V9.75m0 0l-3.75 3.75M12 9.75l3.75 3.75M17.25 8.25L21 12m-18 0l3.75-3.75" />
...
export const Cog6ToothIcon: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M9.594 3.94c.09-.542.56-1.007 1.113-1.113l.448-.113c.542-.137 1.096-.137 1.638 0l.448.113c.553.106 1.023.571 1.113 1.113l.068.411c.065.395.065.79 0 1.185l-.068.411c-.09.542-.56 1.007-1.113 1.113l-.448.113c-.542.137-1.096-.137-1.638 0l-.448-.113a1.25 1.25 0 01-1.113-1.113l-.068-.411c-.065-.395-.065-.79 0-1.185l.068-.411zM12 15a3 3 0 100-6 3 3 0 000 6z" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 12.75c-1.655 0-3.13.845-4 2.25V18.75c0 .621.504 1.125 1.125 1.125h9.75c.621 0 1.125-.504 1.125-1.125V15c-.87-.405-1.87-.6-2.932-.672A7.502 7.502 0 0012 12.75z" />
  </svg>
);

export const WandIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M9.528 1.718a.75.75 0 0 1 .162.819A8.97 8.97 0 0 0 9 6a9 9 0 0 0 9 9 8.97 8.97 0 0 0 3.463-.69a.75.75 0 0 1 .819.162l4.992 4.992a.75.75 0 0 1-.528 1.285h-12a.75.75 0 0 1-.528-1.285l4.992-4.992ZM9.75 12a.75.75 0 0 1 .75-.75h.008a.75.75 0 0 1 .75.75v.008a.75.75 0 0 1-.75.75h-.008a.75.75 0 0 1-.75-.75v-.008ZM9.75 9a.75.75 0 0 0-.75.75v.008c0 .414.336.75.75.75h.008c.414 0 .75-.336.75-.75v-.008a.75.75 0 0 0-.75-.75h-.008ZM12.25 12a.75.75 0 0 1 .75-.75h.008a.75.75 0 0 1 .75.75v.008a.75.75 0 0 1-.75.75h-.008a.75.75 0 0 1-.75-.75v-.008ZM15 9.75a.75.75 0 0 0-.75.75v.008c0 .414.336.75.75.75h.008c.414 0 .75-.336.75-.75v-.008a.75.75 0 0 0-.75-.75h-.008Z" />
    </svg>
);

export const VortexIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 3.5c-4.694 0-8.5 3.806-8.5 8.5s3.806 8.5 8.5 8.5S20.5 16.694 20.5 12" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 6.5c-3.038 0-5.5 2.462-5.5 5.5s2.462 5.5 5.5 5.5S17.5 15.038 17.5 12" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 9.5c-1.38 0-2.5 1.12-2.5 2.5s1.12 2.5 2.5 2.5" />
    </svg>
);
...
export const AdjustmentsIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 3c2.738 0 4.954 2.016 5.5 4.5c.546-2.484 2.762-4.5 5.5-4.5c.55 0 1 .45 1 1s-.45 1-1 1c-3.5 0-6.5 3-6.5 6.5c0 .55-.45 1-1 1s-1-.45-1-1c0-4-3-7-6.5-7c-.55 0-1-.45-1-1s.45-1 1-1z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 21c-2.738 0-4.954-2.016-5.5-4.5c-.546 2.484-2.762 4.5-5.5 4.5c-.55 0-1-.45-1-1s.45-1 1-1c3.5 0 6.5-3 6.5-6.5c0-.55.45-1 1-1s1 .45 1 1c0 4 3 7 6.5 7c.55 0 1 .45 1 1s-.45 1-1 1z" />
    </svg>
);

export const UndoIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M9 15L3 9m0 0l6-6m-6 6h12a6 6 0 016 6v3" />
    </svg>
);
...
export const ExpandIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 3.75v4.5m0-4.5h4.5m-4.5 0L9 9M3.75 20.25v-4.5m0 4.5h4.5m-4.5 0L9 15m11.25-11.25v4.5m0-4.5h-4.5m4.5 0L15 9m11.25 11.25v-4.5m0 4.5h-4.5m4.5 0L15 15" />
    </svg>
);
...
export const ArrowsPointingOutIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 3.75h4.5m0 0h4.5m-4.5 0v4.5m0-4.5V3.75m10.5 0h-4.5m0 0h-4.5m4.5 0v4.5m0-4.5V3.75M3.75 20.25h4.5m0 0h4.5m-4.5 0v-4.5m0 4.5v4.5m10.5-4.5h-4.5m0 0h-4.5m4.5 0v-4.5m0 4.5v4.5" />
    </svg>
);
